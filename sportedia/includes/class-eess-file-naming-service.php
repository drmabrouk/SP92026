...
class EESS_File_Naming_Service {
    ...
    public static function generate_lesson_prep_filename($prep) {
        ...
        if (empty($teacher_name)) $teacher_name = '__';
        ...
        $raw_name = sprintf('__-_%s_-_%s_-_LP%d.%s', $teacher_name, $lesson_date, $prep_id, $ext);
    ...
    public static function generate_term_plan_filename($plan) {
        ...
        $raw_name = sprintf('__-_%s_-_%s_-_TP%d.%s', $teacher_name, $term_label, $plan_id, $ext);
        return self::sanitize_filename($raw_name);
    }
