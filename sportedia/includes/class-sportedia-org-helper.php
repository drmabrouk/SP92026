...
class Sportedia_Org_Helper {
    ...
    public static function get_role_department_mapping() {
        return array(
            'sportedia_coach'              => '  - Sports Activities',
            'sm_teacher'                   => '  - Sports Activities',
            'sm_coordinator'               => '  - Sports Activities',
            'sm_hod'                       => '  - Sports Activities',
            'sm_hr'                        => '   (HR)',
            'sportedia_sports_supervisor'  => 'Player Affairs No ',
            'sportedia_player'             => 'Player Affairs No ',
            'sm_student'                   => 'Player Affairs No ',
            'sm_parent'                    => 'Player Affairs No ',
            'sm_activities_supervisor'     => 'Active  ',
            'sm_finance'                   => ' ',
            'sm_bus_supervisor'            => '  ',
            'sm_transportation_supervisor' => '  ',
            'sportedia_branch_manager'     => '  ',
            'sm_principal'                 => '  ',
            'sm_supervisor'                => '  ',
            'sm_system_admin'              => '  ',
            'subscriber'                   => '  '
    ...
    public static function get_official_subjects() {
        return array(
            1  => array('code' => 1,  'name' => ' ',                'dept_code' => 10),
            2  => array('code' => 2,  'name' => ' ',                'dept_code' => 10),
            3  => array('code' => 3,  'name' => '',                  'dept_code' => 10),
            4  => array('code' => 4,  'name' => ' ',    'dept_code' => 10),
            5  => array('code' => 5,  'name' => '',                  'dept_code' => 10),
            6  => array('code' => 6,  'name' => '  ',      'dept_code' => 10),
            7  => array('code' => 7,  'name' => ' ',             'dept_code' => 10),
            8  => array('code' => 8,  'name' => ' ',               'dept_code' => 10),
            9  => array('code' => 9,  'name' => ' ',         'dept_code' => 10),
            10 => array('code' => 10, 'name' => '  ',   'dept_code' => 10)
        );
    }
    ...
    public static function get_official_departments() {
        return array(
            1  => array('code' => 1,  'name' => '  '),
            2  => array('code' => 2,  'name' => '  '),
            3  => array('code' => 3,  'name' => 'Player Affairs No'),
            4  => array('code' => 4,  'name' => ' '),
            5  => array('code' => 5,  'name' => ' '),
            6  => array('code' => 6,  'name' => '  '),
            10 => array('code' => 10, 'name' => '   '),
            18 => array('code' => 18, 'name' => ' No Active '),
            20 => array('code' => 20, 'name' => '  ')
        );
    }
    ...
    public static function get_official_grades() {
        return array(
            1  => array('code' => 1,  'name' => '  (Under 8)'),
            2  => array('code' => 2,  'name' => '  (Under 12)'),
            3  => array('code' => 3,  'name' => '  (Under 16)'),
            4  => array('code' => 4,  'name' => '   (Senior)'),
            5  => array('code' => 5,  'name' => '  Advanced'),
            6  => array('code' => 6,  'name' => '  ')
        );
    }
    ...
    public static function get_official_sections() {
        return array(
            1  => array('code' => 1,  'ar' => '',  'en' => 'A'),
            2  => array('code' => 2,  'ar' => '',  'en' => 'B'),
            3  => array('code' => 3,  'ar' => '',  'en' => 'C'),
            4  => array('code' => 4,  'ar' => '',  'en' => 'D')
        );
    }
    ...
    public static function seed_mandatory_institutions() {
        ...
        $branches = array(
            2 => array('name' => '  -   ', 'emirate' => ''),
            3 => array('name' => '  -  ', 'emirate' => ''),
            4 => array('name' => '  -  ', 'emirate' => '')
        );
    ...
    public static function ensure_institutions_columns_exist() {
        ...
        $cols = array(
            ...
            'emirate' => "VARCHAR(100) DEFAULT '' NOT NULL",
