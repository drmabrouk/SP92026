...
<div class="sm-admin-panel" dir="rtl" style="font-family: system-ui, -apple-system, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; color: #1e293b;">
            ...
            <?php if (!$is_parent): ?>
                ...
                <div style="position: relative; display: inline-block;">
                    <button type="button" onclick="const d = document.getElementById('eess-violation-export-dropdown'); d.style.display = d.style.display === 'none' ? 'block' : 'none'; event.stopPropagation();" class="eess-hdr-btn" style="background: #f8fafc !important; color: #334155 !important; border: 1px solid #cbd5e1 !important; border-radius: 12px; padding: 0 16px; height: 42px; font-weight: 700; font-size: 13px; display: inline-flex; align-items: center; gap: 8px; cursor: pointer; transition: all 0.2s; box-shadow: 0 1px 2px rgba(0,0,0,0.04);">
                        ...
                        <span style="color: #334155 !important;">Export </span>
                    ...
                    <div id="eess-violation-export-dropdown" style="display: none; position: absolute; left: 0; top: 115%; background: #ffffff; border: 1px solid #cbd5e1; border-radius: 14px; width: 230px; box-shadow: 0 10px 25px rgba(0,0,0,0.1); z-index: 99999; padding: 6px 0; text-align: right;">
                        <div style="padding: 6px 16px; font-size: 11px; color: #94a3b8; font-weight: 800; border-bottom: 1px solid #f1f5f9;">Upload  (PDF)</div>
                        ...
                        <div style="padding: 6px 16px; font-size: 11px; color: #94a3b8; font-weight: 800; border-bottom: 1px solid #f1f5f9;">Export  (CSV)</div>
                ...
                <?php elseif (current_user_can('_') || current_user_can('_') || current_user_can('manage_options')): ?>
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(180px, 1fr)); gap: 16px; align-items: end;">
                ...
                <div>
                    ...
                    <div style="position: relative;">
                        <input type="text" id="filter_student_search" name="student_search" value="<?php echo esc_attr($_GET['student_search'] ?? ''); ?>" placeholder="Player Name /   / ..." style="width: 100%; height: 34px; padding: 0 32px 0 10px; border: 1px solid #cbd5e1; border-radius: 8px; font-size: 12px; outline: none; background: #f8fafc; transition: all 0.2s;" onfocus="this.style.borderColor='#dc2626'; this.style.background='#fff';" onblur="this.style.borderColor='#cbd5e1'; this.style.background='#f8fafc';">
    ...
    <div id="violation-import-form" style="display:none; background: #f8fafc; padding: 24px; border: 2px dashed #cbd5e1; border-radius: 16px; margin-bottom: 20px;">
        <h3 style="margin-top:0; color:#1e293b; font-size: 16px; font-weight: 800;"> Import No   (Excel / CSV)</h3>

        <p style="font-size: 12.5px; color: #64748b; line-height: 1.6; margin-bottom: 15px;">
                  No  <strong>Player ID (Student Number)   A</strong>     No   .
        </p>

        <div style="background:#fff; padding:15px; border-radius:12px; border:1px solid #e2e8f0; margin-bottom:20px; overflow-x: auto;">
            <p style="font-size:12.5px; font-weight:700; margin-bottom:10px; color:#334155;">  No  ( ):</p>
            <table style="width:100%; font-size:11px; border-collapse:collapse; text-align:center; min-width: 600px;">
                <thead>
                    <tr style="background:#f1f5f9;">
                        ...
                        <th style="border:1px solid #cbd5e1; padding:6px;">C: Gender</th>
                        <th style="border:1px solid #cbd5e1; padding:6px;">D: Academy </th>
                        ...
                        <th style="border:1px solid #cbd5e1; padding:6px; color:#dc2626;">G:   *</th>
                        <th style="border:1px solid #cbd5e1; padding:6px;">H:  </th>
                        <th style="border:1px solid #cbd5e1; padding:6px; color:#dc2626;">I:  *</th>
                        <th style="border:1px solid #cbd5e1; padding:6px; color:#dc2626;">J:  *</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        ...
                        <td style="border:1px solid #cbd5e1; padding:6px;"></td>
                        <td style="border:1px solid #cbd5e1; padding:6px;">Academy  Home</td>
                        <td style="border:1px solid #cbd5e1; padding:6px;">Training Group 10</td>
                        <td style="border:1px solid #cbd5e1; padding:6px;">1</td>
                        <td style="border:1px solid #cbd5e1; padding:6px; font-weight:700; color:#dc2626;"></td>
        ...
        <form method="post" enctype="multipart/form-data" onsubmit="return handleImportSubmit(this, 'sm_import_violations_csv')">
            ...
            <div class="sm-form-group">
                <label class="sm-label" style="font-size: 13px; font-weight: 700; color: #334155;">  CSV / Excel  :</label>
            ...
            <div style="display:flex; gap:10px; margin-top:20px;">
                <button type="submit" name="sm_import_violations_csv" class="sm-btn" style="width:auto; background:#16a34a; border-radius: 10px; height: 40px; padding: 0 18px; font-weight: 700;">Import No  </button>
    ...
    <div style="background: #ffffff; border-radius: 20px; border: 1px solid #e2e8f0; box-shadow: 0 4px 20px rgba(0,0,0,0.02); overflow: hidden; margin-bottom: 24px;">
            ...
            <div style="display: flex; align-items: center; gap: 12px; flex-wrap: wrap;">
                ...
                <div style="display: flex; align-items: center; gap: 6px; font-size: 12.5px; color: #64748b; font-weight: 600;">
                    ...
                    <select id="table_sort_select" onchange="changeTableSorting(this.value)" style="height: 36px; padding: 0 28px 0 12px; border: 1px solid #cbd5e1; border-radius: 10px; font-size: 12.5px; color: #334155; font-weight: 700; outline: none; background: #f8fafc; cursor: pointer;">
                        <option value="created_at_DESC" <?php selected($orderby == 'created_at' && $order == 'DESC'); ?>> No</option>
                        <option value="created_at_ASC" <?php selected($orderby == 'created_at' && $order == 'ASC'); ?>> No</option>
                        <option value="degree_DESC" <?php selected($orderby == 'degree' && $order == 'DESC'); ?>> </option>
                        <option value="degree_ASC" <?php selected($orderby == 'degree' && $order == 'ASC'); ?>> </option>
                        <option value="student_ASC" <?php selected($orderby == 'student' && $order == 'ASC'); ?>>Player Name ( - )</option>
                    </select>
                </div>
            ...
            <table style="width: 100%; border-collapse: separate; border-spacing: 0; text-align: right;">
                <thead>
                    <tr style="background: #f8fafc; border-bottom: 1px solid #e2e8f0;">
                        <th style="padding: 14px 18px; font-size: 12.5px; font-weight: 800; color: #475569; border-bottom: 2px solid #e2e8f0; width: 28%;">No</th>
                        <th style="padding: 14px 18px; font-size: 12.5px; font-weight: 800; color: #475569; border-bottom: 2px solid #e2e8f0; width: 20%;">Academy  / Training Group / Training Group</th>
                        <th style="padding: 14px 18px; font-size: 12.5px; font-weight: 800; color: #475569; border-bottom: 2px solid #e2e8f0; width: 14%;"> </th>
                        <th style="padding: 14px 18px; font-size: 12.5px; font-weight: 800; color: #475569; border-bottom: 2px solid #e2e8f0; width: 18%;">  </th>
                        <th style="padding: 14px 18px; font-size: 12.5px; font-weight: 800; color: #475569; border-bottom: 2px solid #e2e8f0; text-align: center; width: 5%;"></th>
                        <th style="padding: 14px 18px; font-size: 12.5px; font-weight: 800; color: #475569; border-bottom: 2px solid #e2e8f0; text-align: center; width: 8%;"> / Status</th>
                        <th style="padding: 14px 18px; font-size: 12.5px; font-weight: 800; color: #475569; border-bottom: 2px solid #e2e8f0; text-align: center; width: 17%;">Actions </th>
                    </tr>
                </thead>
        ...
        <div style="padding: 16px 24px; border-top: 1px solid #f1f5f9; background: #ffffff; display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 14px;">
            <div id="pagination-info" style="font-size: 13px; color: #64748b; font-weight: 600;">
                View <span id="pag-from" style="color: #0f172a; font-weight: 800;"><?php echo $from_num; ?></span> - <span id="pag-to" style="color: #0f172a; font-weight: 800;"><?php echo $to_num; ?></span>   <span id="pag-total" style="color: #0f172a; font-weight: 800;"><?php echo $total_records; ?></span>
            </div>
            ...
            <div id="pagination-controls" style="display: flex; align-items: center; gap: 6px;">
                ...
                ?>
                <button type="button" onclick="goToPage(1)" <?php if ($prev_disabled) echo 'disabled'; ?> class="pag-btn" style="height: 36px; padding: 0 10px; border-radius: 8px; border: 1px solid #cbd5e1; background: <?php echo $prev_disabled ? '#f8fafc' : '#ffffff'; ?>; color: <?php echo $prev_disabled ? '#94a3b8' : '#334155'; ?>; font-size: 12px; font-weight: 700; cursor: <?php echo $prev_disabled ? 'not-allowed' : 'pointer'; ?>;"></button>
    ...
    <div id="edit-record-modal" class="sm-modal-overlay" style="display: none;">
        <div class="sm-modal-content" style="max-width: 750px; border-radius: 20px; padding: 28px;">
            <div class="sm-modal-header" style="border-bottom: 1px solid #e2e8f0; padding-bottom: 14px; margin-bottom: 20px; display: flex; justify-content: space-between; align-items: center;">
                <h3 style="margin:0; font-size: 18px; font-weight: 800; color: #0f172a;">Edit  </h3>
            ...
            <form method="post" id="edit-record-form" class="sm-form-container">
                ...
                <div style="display: grid; grid-template-columns: 1fr 2fr; gap: 16px; background: #f8fafc; padding: 18px; border-radius: 14px; border: 1px solid #e2e8f0; margin-bottom: 20px;">
                    <div class="sm-form-group" style="margin-bottom:0;">
                        <label class="sm-label" style="font-size: 12.5px; font-weight: 700; color: #334155;">  (Level):</label>
                    ...
                    <div class="sm-form-group" style="margin-bottom:0;">
                        <label class="sm-label" style="font-size: 12.5px; font-weight: 700; color: #334155;">  /  :</label>
                ...
                <div style="display:flex; gap:12px; justify-content: flex-end;">
                    <button type="submit" name="sm_update_record" class="sm-btn" style="background: #dc2626; color: #fff; height: 42px; border-radius: 10px; padding: 0 20px; font-weight: 800; border: none;">Save </button>
            ...
            <div style="display: flex; flex-direction: column; gap: 16px;">
                <div style="background: #f8fafc; border-radius: 14px; padding: 16px; border: 1px solid #e2e8f0; display: flex; align-items: center; gap: 14px;">
                    ...
                    <div>
                        ...
                        <div style="font-size: 12px; color: #64748b; margin-top: 3px;">
                            Academy : <span id="view_school_name" style="font-weight: 700; color: #334155;"></span> | Training Group Training Group: <span id="view_class_sec" style="font-weight: 700; color: #334155;"></span>
                        </div>
                    </div>
                </div>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px;">
                    <div style="background: #ffffff; border: 1px solid #e2e8f0; padding: 12px 16px; border-radius: 12px;">
                        <span style="font-size: 11px; color: #64748b; font-weight: 700; display: block; margin-bottom: 4px;">  / </span>
    ...
    <div id="delete-record-modal" class="sm-modal-overlay" style="display: none;">
        <div class="sm-modal-content" style="max-width: 400px; text-align: center; border-radius: 20px; padding: 28px;">
            ...
            <h3 style="margin:0 0 10px 0; border:none; font-size: 18px; font-weight: 800; color: #0f172a;">Confirm Delete </h3>
            <p style="color: #64748b; font-size: 13.5px; margin-bottom: 20px; line-height: 1.5;">    Delete    No     .</p>
            <input type="hidden" id="confirm_delete_record_id">
            <div style="display: flex; gap: 12px; justify-content: center;">
                <button onclick="executeDeleteRecord()" class="sm-btn" style="background: #dc2626; color: #fff; border-radius: 10px; height: 40px; padding: 0 20px; font-weight: 800; border: none;">Delete </button>
                <button onclick="document.getElementById('delete-record-modal').style.display='none'" class="sm-btn" style="background: #cbd5e1; color: #334155; border-radius: 10px; height: 40px; padding: 0 20px; font-weight: 700; border: none;"></button>
            </div>
        </div>
    </div>
    ...
    (function() {
        ...
        window.viewViolationDetails = function(record) {
            ...
            document.getElementById('view_school_name').innerText = record.school_name || 'Academy  Home';
            ...
            document.getElementById('view_degree').innerText = 'Level /  ' + (record.degree || 1);
            ...
            document.getElementById('view_details_text').innerText = record.details || 'No    .';
            document.getElementById('view_action_text').innerText = record.action_taken || '     .';
        ...
        window.executeDeleteRecord = function() {
            ...
            .then(res => {
                if (res.success) {
                    if (typeof smShowNotification === 'function') smShowNotification(' Delete  ');
