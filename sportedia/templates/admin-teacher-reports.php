...
<div class="sm-content-wrapper" dir="rtl">
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 25px;">
        <h3 style="margin:0; border:none; padding:0;"> No </h3>
        <span class="sm-badge sm-badge-high"><?php echo count($records); ?> No Pending</span>
    </div>
                    ...
                    ?>
                        <tr>
                            ...
                            <td style="font-weight: 600; color: var(--sm-primary-color);">
                                <?php echo $teacher ? esc_html($teacher->display_name) : ' '; ?>
                            </td>
                            ...
                            <td>
                                <div style="display: flex; gap: 8px; justify-content: flex-end;">
                                    <button onclick="reviewReportDecision(<?php echo htmlspecialchars(json_encode($row)); ?>)" class="sm-btn sm-btn-outline" style="padding: 5px 12px; font-size: 12px;"></button>
        ...
        <div class="sm-modal-content" style="max-width: 600px;">
            ...
            <form method="post" action="">
                ...
                <div class="sm-form-group">
                    <label class="sm-label">Edit   ():</label>
                    <input type="text" name="action_taken" id="decision_action" class="sm-input" placeholder=":    ...">
                </div>
                ...
                <div style="display: flex; gap: 15px; margin-top: 25px;">
                    <button type="submit" name="sm_update_record" class="sm-btn" style="background:#38a169;"> Save </button>
                    <button type="button" onclick="document.getElementById('decision-modal').style.display='none'" class="sm-btn" style="background:#cbd5e0; color:#2d3748;"></button>
                </div>
            </form>
        </div>
    </div>
