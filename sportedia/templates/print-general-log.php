...
<body>
    <div class="no-print" style="text-align:center; margin-bottom: 20px; padding: 20px;">
        <button onclick="window.print()" style="padding: 10px 25px; background: #27ae60; color: #fff; border: none; border-radius: 5px; cursor: pointer;">Print </button>
    </div>

    <?php $school = SM_Settings::get_school_info(); ?>
    <div class="report-header">
        <h2 style="margin: 0;"><?php echo esc_html($school['school_name']); ?></h2>
        <h3 style="margin: 10px 0 0 0; color: #4a5568;">   No</h3>
    ...
    <div style="margin-top: 50px; text-align: left; font-size: 0.9em;">
        <p>  Academy : <?php echo esc_html($school['school_principal_name'] ?? ''); ?></p>
        <br>
        <p>: ................................................</p>
    </div>
</body>
