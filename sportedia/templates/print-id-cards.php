...
<body>
    <div class="no-print" style="text-align:center; margin-bottom: 20px;">
        <button onclick="window.print()" style="padding: 10px 20px; background: #27ae60; color: white; border: none; cursor: pointer; border-radius: 5px;"> Print</button>
    </div>
    <?php
    ...
    <div class="cards-container">
        ...
        <div class="id-card" style="--sm-primary-color: <?php echo SM_Settings::get_appearance()['primary_color']; ?>;">
            ...
            <div class="footer">
                 Academy : <?php echo esc_html($school['school_principal_name'] ?? ''); ?> | <?php echo esc_html($school['phone']); ?>
            </div>
        </div>
        <?php endforeach; ?>
    </div>
