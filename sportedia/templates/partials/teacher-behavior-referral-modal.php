    ...
    <div style="background: #ffffff; border-radius: 20px; max-width: 780px; width: 100%; border: 1px solid #cbd5e1; box-shadow: 0 25px 50px -12px rgba(0, 0, 0, 0.3); overflow: hidden; display: flex; flex-direction: column; max-height: 92vh;">
        ...
        <div style="background: #0f172a; color: #ffffff; padding: 16px 24px; border-bottom: 1px solid #1e293b; display: flex; justify-content: space-between; align-items: center; width: 100%; box-sizing: border-box;">
            <div style="display: flex; align-items: center; gap: 12px;">
                ...
                <div>
                    <h3 style="margin: 0; font-size: 16px; font-weight: 800; color: #ffffff; font-family: 'Cairo', sans-serif;">   No –    </h3>
                    <p style="margin: 3px 0 0 0; font-size: 11.5px; color: #94a3b8; font-weight: 600;">       No</p>
                </div>
            </div>
        ...
        <div style="background: #f8fafc; padding: 12px 24px; border-bottom: 1px solid #e2e8f0; display: flex; justify-content: space-between; align-items: center;">
            <div id="ref-step-indicator-1" class="ref-step-node ref-step-active">1. No</div>
            <div id="ref-step-indicator-2" class="ref-step-node">2. </div>
            <div id="ref-step-indicator-3" class="ref-step-node">3. </div>
            <div id="ref-step-indicator-4" class="ref-step-node">4.  No</div>
            <div id="ref-step-indicator-5" class="ref-step-node">5. </div>
            <div id="ref-step-indicator-6" class="ref-step-node">6.  </div>
        </div>
        ...
        <form id="eess-teacher-referral-form" style="padding: 24px; overflow-y: auto; flex: 1;" onsubmit="eessSubmitTeacherReferral(event)">
            ...
            <div id="ref-step-1" class="ref-step-content" style="display: block;">
                <h4 style="margin: 0 0 15px 0; font-size: 14px; font-weight: 800; color: #0f172a;"> 1:  No   </h4>
                <div style="margin-bottom: 15px;">
                    <label style="display: block; font-size: 12.5px; font-weight: 700; color: #334155; margin-bottom: 6px;">Search  Player Name   *</label>
                    <input type="text" id="ref_student_query" onkeyup="eessSearchReferralStudent(this.value)" class="sm-input" placeholder=" Player Name    ..." style="width: 100%; height: 42px; border-radius: 10px; padding: 0 14px; font-size: 13px;">
            ...
            <div id="ref-step-2" class="ref-step-content" style="display: none;">
                <h4 style="margin: 0 0 15px 0; font-size: 14px; font-weight: 800; color: #0f172a;"> 2:      No</h4>
                <div style="margin-bottom: 15px;">
                    <label style="display: block; font-size: 12.5px; font-weight: 700; color: #334155; margin-bottom: 6px;">  /    *</label>
                    <input type="text" id="ref_title" required placeholder=":  No     ..." style="width: 100%; height: 42px; border: 1px solid #cbd5e1; border-radius: 10px; padding: 0 14px; font-size: 13px;">
                </div>

                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px;">
                    <div>
                        <label style="display: block; font-size: 12.5px; font-weight: 700; color: #334155; margin-bottom: 6px;">  No</label>
                        <select id="ref_classification" style="width: 100%; height: 42px; border: 1px solid #cbd5e1; border-radius: 10px; padding: 0 12px; font-size: 13px;">
                            ...
                            <option value="labs">  /  Active</option>
                            <option value="bus">  </option>
                            <option value="general"> /  Academy </option>
                        </select>
                    </div>
                    <div>
                        <label style="display: block; font-size: 12.5px; font-weight: 700; color: #334155; margin-bottom: 6px;">   </label>
            ...
            <div id="ref-step-3" class="ref-step-content" style="display: none;">
                <h4 style="margin: 0 0 15px 0; font-size: 14px; font-weight: 800; color: #0f172a;"> 3:    </h4>
                <div style="margin-bottom: 15px;">
                    <label style="display: block; font-size: 12.5px; font-weight: 700; color: #334155; margin-bottom: 6px;">   No *</label>
                    <textarea id="ref_details" required rows="5" placeholder="     No    Training Group..." style="width: 100%; border: 1px solid #cbd5e1; border-radius: 10px; padding: 10px 14px; font-size: 13px; font-family: 'Cairo', sans-serif;"></textarea>
                </div>
            </div>

            <!-- Step 4: Evidence & Images -->
            <div id="ref-step-4" class="ref-step-content" style="display: none;">
                <h4 style="margin: 0 0 15px 0; font-size: 14px; font-weight: 800; color: #0f172a;"> 4:    ( )</h4>
                <div style="margin-bottom: 15px;">
                    <label style="display: block; font-size: 12.5px; font-weight: 700; color: #334155; margin-bottom: 6px;">    </label>
            ...
            <div id="ref-step-5" class="ref-step-content" style="display: none;">
                <h4 style="margin: 0 0 15px 0; font-size: 14px; font-weight: 800; color: #0f172a;"> 5:     PDF ()</h4>
                <div style="margin-bottom: 15px;">
                    <label style="display: block; font-size: 12.5px; font-weight: 700; color: #334155; margin-bottom: 6px;">   (PDF / Doc)</label>
            ...
            <div id="ref-step-6" class="ref-step-content" style="display: none;">
                <h4 style="margin: 0 0 15px 0; font-size: 14px; font-weight: 800; color: #0f172a;"> 6:      </h4>
                <div style="background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 12px; padding: 15px; margin-bottom: 15px; font-size: 13px;">
                    <div style="margin-bottom: 8px;"><strong>No:</strong> <span id="rev_student_name">---</span></div>
                    <div style="margin-bottom: 8px;"><strong> :</strong> <span id="rev_title">---</span></div>
                    <div style="margin-bottom: 8px;"><strong>:</strong> <span id="rev_classification">---</span></div>
                    <div style="margin-bottom: 8px;"><strong>:</strong> <span id="rev_details">---</span></div>
                    <div style="color: #dc2626; font-size: 11.5px; font-weight: 700; margin-top: 10px;">⚠️  Send      No No.        No No     .</div>
                </div>
            </div>
            ...
            <div style="display: flex; justify-content: space-between; align-items: center; margin-top: 20px; padding-top: 15px; border-top: 1px solid #e2e8f0;">
                <button type="button" id="ref-prev-btn" onclick="eessTeacherReferralNav(-1)" style="background: #f1f5f9; color: #475569; border: 1px solid #cbd5e1; border-radius: 10px; padding: 8px 18px; font-weight: 700; font-size: 13px; cursor: pointer; display: none;">← Previous</button>
                <div></div>
                <button type="button" id="ref-next-btn" onclick="eessTeacherReferralNav(1)" style="background: #dc2626; color: #ffffff; border: none; border-radius: 10px; padding: 8px 22px; font-weight: 800; font-size: 13.5px; cursor: pointer;">Next →</button>
                <button type="submit" id="ref-submit-btn" style="background: #16a34a; color: #ffffff; border: none; border-radius: 10px; padding: 8px 24px; font-weight: 800; font-size: 13.5px; cursor: pointer; display: none;">   </button>
            </div>
...
function eessTeacherReferralNav(dir) {
    if (dir === 1) {
        if (eessRefCurrentStep === 1 && !document.getElementById('ref_selected_student_id').value) {
            if (typeof smShowNotification === 'function') smShowNotification('  No  No', true);
            return;
        }
        if (eessRefCurrentStep === 2 && !document.getElementById('ref_title').value) {
            if (typeof smShowNotification === 'function') smShowNotification('   / ', true);
            return;
        }
...
function eessSubmitTeacherReferral(e) {
    ...
    .then(res => {
        ...
        if (res.success) {
            ...
            if (typeof smShowNotification === 'function') smShowNotification(': ' + (res.data || ' Save '), true);
        }
    });
}
</script>
