...
<div class="sm-printing-center" dir="rtl">
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 30px;">
        <h3 style="margin:0; border:none; padding:0;"> Print </h3>
    ...
    <div style="display: flex; flex-direction: column; gap: 40px;">
        ...
        <div>
            ...
            <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 20px;">
                ...
                <div style="background: #fff; padding: 25px; border-radius: 15px; border: 1px solid var(--sm-border-color); display: flex; flex-direction: column; justify-content: space-between; box-shadow: var(--sm-shadow);">
                    <div>
                        ...
                        <h4 style="margin: 0 0 10px 0; border: none; font-weight: 800; font-size: 15px;"> No ()</h4>
                <p style="font-size: 11px; color: #718096; line-height: 1.6; margin-bottom: 20px;">Print    No      .</p>
            ...
            <button onclick="printCards()" class="sm-btn" style="background: #3182CE; font-size: 12px;">Print </button>
        </div>
                ...
                <div style="background: #fff; padding: 25px; border-radius: 15px; border: 1px solid var(--sm-border-color); display: flex; flex-direction: column; justify-content: space-between; box-shadow: var(--sm-shadow);">
                    <div>
                        ...
                        <h4 style="margin: 0 0 10px 0; border: none; font-weight: 800; font-size: 15px;"> No </h4>
                        <p style="font-size: 11px; color: #718096; line-height: 1.6; margin-bottom: 20px;">    No   No .</p>
                        <div class="sm-form-group">
                    ...
                    <button onclick="printSpecificCard()" class="sm-btn" style="background: #E53E3E; font-size: 12px;"> </button>
                </div>
            </div>
        </div>
            ...
            <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 20px;">
                ...
                <div style="background: #fff; padding: 25px; border-radius: 15px; border: 1px solid var(--sm-border-color); display: flex; flex-direction: column; justify-content: space-between; box-shadow: var(--sm-shadow);">
                    <div>
                        ...
                        <h4 style="margin: 0 0 10px 0; border: none; font-weight: 800; font-size: 15px;">  </h4>
                        <p style="font-size: 11px; color: #718096; line-height: 1.6; margin-bottom: 20px;">  No         Previous.</p>
                        <div class="sm-form-group">
                            <input type="date" id="abs_daily_date" class="sm-input" value="<?php echo date('Y-m-d'); ?>" style="font-size: 12px;">
                        </div>
                    </div>
                    <button onclick="printAbsenceFromCenter('daily')" class="sm-btn" style="background: #e53e3e; font-size: 12px;">Print  </button>
                </div>
                ...
                <div style="background: #fff; padding: 25px; border-radius: 15px; border: 1px solid var(--sm-border-color); display: flex; flex-direction: column; justify-content: space-between; box-shadow: var(--sm-shadow);">
                    <div>
                        ...
                        <h4 style="margin: 0 0 10px 0; border: none; font-weight: 800; font-size: 15px;">  </h4>
                        <p style="font-size: 11px; color: #718096; line-height: 1.6; margin-bottom: 20px;">Print      Training Groups   .</p>
                    ...
                    <button onclick="printAttendanceSheets()" class="sm-btn" style="background: #3182CE; font-size: 12px;">Print </button>
                </div>
                ...
                <div style="background: #fff; padding: 25px; border-radius: 15px; border: 1px solid var(--sm-border-color); display: flex; flex-direction: column; justify-content: space-between; box-shadow: var(--sm-shadow);">
                    <div>
                        ...
                        <h4 style="margin: 0 0 10px 0; border: none; font-weight: 800; font-size: 15px;">No  </h4>
                        <p style="font-size: 11px; color: #718096; line-height: 1.6; margin-bottom: 20px;"> No       No Training Group  .</p>
                    </div>
                    <button onclick="printAbsenceFromCenter('term')" class="sm-btn" style="background: #111F35; font-size: 12px;">  Training Group</button>
                </div>
            </div>
        </div>
        ...
        <div>
            <h4 style="margin-bottom: 20px; padding-bottom: 10px; border-bottom: 2px solid #38A169; display: flex; align-items: center; gap: 10px; color: var(--sm-dark-color);">
                <span class="dashicons dashicons-warning"></span>   No
            </h4>
            <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 20px;">
                ...
                <div style="background: #fff; padding: 25px; border-radius: 15px; border: 1px solid var(--sm-border-color); display: flex; flex-direction: column; justify-content: space-between; box-shadow: var(--sm-shadow);">
                    <div>
                        ...
                        <h4 style="margin: 0 0 10px 0; border: none; font-weight: 800; font-size: 15px;"> No</h4>
                        <p style="font-size: 11px; color: #718096; line-height: 1.6; margin-bottom: 20px;">     No  Print .</p>
                        <div class="sm-form-group">
                    ...
                    <button onclick="printReport()" class="sm-btn" style="background: #38A169; font-size: 12px;">View </button>
                </div>
                ...
                <div style="background: #fff; padding: 25px; border-radius: 15px; border: 1px solid var(--sm-border-color); display: flex; flex-direction: column; justify-content: space-between; box-shadow: var(--sm-shadow);">
                    <div>
                        ...
                        <h4 style="margin: 0 0 10px 0; border: none; font-weight: 800; font-size: 15px;">  </h4>
                        <p style="font-size: 11px; color: #718096; line-height: 1.6; margin-bottom: 20px;">Print      Academy  No  .</p>
                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 8px; margin-bottom: 15px;">
                    ...
                    <button onclick="printGeneralLog()" class="sm-btn" style="background: #111F35; font-size: 12px;">Upload </button>
                </div>
                ...
                <div style="background: #fff; padding: 25px; border-radius: 15px; border: 1px solid var(--sm-border-color); display: flex; flex-direction: column; justify-content: space-between; box-shadow: var(--sm-shadow);">
                    <div>
                        ...
                        <h4 style="margin: 0 0 10px 0; border: none; font-weight: 800; font-size: 15px;">  Training Group</h4>
                        <p style="font-size: 11px; color: #718096; line-height: 1.6; margin-bottom: 20px;">    Level     .</p>
                        <div class="sm-form-group">
                    ...
                    <button onclick="alert(':  Training Groups')" class="sm-btn" style="background: #805AD5; font-size: 12px;"> </button>
                </div>
            </div>
        </div>
            ...
            <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 20px;">
                ...
                <div style="background: #fff; padding: 25px; border-radius: 15px; border: 1px solid var(--sm-border-color); display: flex; flex-direction: column; justify-content: space-between; box-shadow: var(--sm-shadow);">
                    <div>
                        ...
                        <h4 style="margin: 0 0 10px 0; border: none; font-weight: 800; font-size: 15px;"> No </h4>
                        <p style="font-size: 11px; color: #718096; line-height: 1.6; margin-bottom: 20px;">Print   No Academy    Training Group Training Group.</p>
                    </div>
                    <button onclick="alert(': Print  ')" class="sm-btn" style="background: #2B6CB0; font-size: 12px;">Print </button>
                </div>
                ...
                <div style="background: #fff; padding: 25px; border-radius: 15px; border: 1px solid var(--sm-border-color); display: flex; flex-direction: column; justify-content: space-between; box-shadow: var(--sm-shadow);">
                    <div>
                        ...
                        <h4 style="margin: 0 0 10px 0; border: none; font-weight: 800; font-size: 15px;">  No</h4>
                        <p style="font-size: 11px; color: #718096; line-height: 1.6; margin-bottom: 20px;">   No  Username () Password .</p>
                        <div class="sm-form-group">
                    ...
                    <div style="display: flex; gap: 8px;">
                        <button onclick="printCredentials()" class="sm-btn" style="background: #4A5568; font-size: 11px; flex: 1;"> </button>
                        <button onclick="printCredentialsCard()" class="sm-btn" style="background: #8A244B; font-size: 11px; flex: 1;"> </button>
                    </div>
                </div>
                ...
                <div style="background: #fff; padding: 25px; border-radius: 15px; border: 1px solid var(--sm-border-color); display: flex; flex-direction: column; justify-content: space-between; box-shadow: var(--sm-shadow);">
                    <div>
                        ...
                        <h4 style="margin: 0 0 10px 0; border: none; font-weight: 800; font-size: 15px;">  No </h4>
                        <p style="font-size: 11px; color: #718096; line-height: 1.6; margin-bottom: 20px;">   (No  Password) No  .</p>
                        <div class="sm-form-group">
                    ...
                    <button onclick="printSingleStudentCreds()" class="sm-btn" style="background: #D53F8C; font-size: 12px;">  </button>
                </div>
            </div>
        </div>
        ...
        <div style="grid-column: 1 / -1; background: #f8fafc; padding: 30px; border-radius: 12px; border: 2px dashed #cbd5e1; margin-top: 20px;">
            <h4 style="margin-top:0; color:var(--sm-secondary-color); display:flex; align-items:center; gap:10px;">
                <span class="dashicons dashicons-media-spreadsheet"></span>    No
            </h4>
            <p style="font-size: 0.9em; color: #64748b; margin-bottom: 20px;"> Upload  Next           .</p>

            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 15px;">
                <a href="data:text/csv;charset=utf-8,<?php echo rawurlencode("No,Training Group,,\nPlayer Name,Training Group ,parent@example.com,STU001"); ?>" download="students_template.csv" class="sm-btn" style="background:#fff; color:#2d3748; border:1px solid #cbd5e1; font-size:13px; text-decoration:none; display:flex; align-items:center; justify-content:center; gap:8px;">
                    <span class="dashicons dashicons-download"></span>  No
                </a>
                <a href="data:text/csv;charset=utf-8,<?php echo rawurlencode("No,,, \n  Mother,parent_user,parent@example.com,pass123"); ?>" download="parents_template.csv" class="sm-btn" style="background:#fff; color:#2d3748; border:1px solid #cbd5e1; font-size:13px; text-decoration:none; display:flex; align-items:center; justify-content:center; gap:8px;">
                    <span class="dashicons dashicons-download"></span>   Mother
                </a>
                <a href="data:text/csv;charset=utf-8,<?php echo rawurlencode("No,,, ,,, \n ,teacher_user,teacher@example.com,T100, ,0500000000,pass123"); ?>" download="teachers_template.csv" class="sm-btn" style="background:#fff; color:#2d3748; border:1px solid #cbd5e1; font-size:13px; text-decoration:none; display:flex; align-items:center; justify-content:center; gap:8px;">
