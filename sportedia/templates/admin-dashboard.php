...
<div class="sm-content-wrapper" dir="rtl">
    <h1>نظام إدارة الأكاديمية الرياضية - لوحة التحكم</h1>
    <hr>
    ...
    <?php else: ?>
        <div class="welcome-panel" style="padding: 20px; margin-top: 20px;">
            ...
            <p>لديك صلاحية الوصول المحدود لنظام إدارة الأكاديمية الرياضية. استخدم القائمة الجانبية للوصول للوظائف المتاحة لك.</p>
        </div>
    <?php endif; ?>
    ...
    <div style="display: flex; gap: 20px; margin-top: 20px; flex-wrap: wrap;">
        ...
        <div style="flex: 1; min-width: 300px; background: #fff; padding: 25px; border: 1px solid var(--sm-border-color); border-radius: var(--sm-radius); box-shadow: var(--sm-shadow);">
            ...
            <p>يمكنك إضافة طلاب جدد، إدارة المدربين، واستعراض كافة السجلات.</p>
            <a href="admin.php?page=sm-students" class="sm-btn">إدارة اللاعبين</a>
        </div>
        <?php endif; ?>
