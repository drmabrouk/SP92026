...
<body>
    <div class="header">
        ...
        <div class="report-title">   No ( Mother / No)</div>
        <div style="font-size: 12px; margin-top: 5px;"> : <?php echo date_i18n('j F Y'); ?></div>
    </div>
    ...
    <div class="no-print" style="margin-top: 30px; text-align: center;">
        <button onclick="window.print()" style="padding: 10px 30px; background: #111F35; color: #fff; border: none; border-radius: 8px; cursor: pointer; font-family: 'Rubik'; font-weight: 700;">Print  </button>
    </div>
</body>
</html>
