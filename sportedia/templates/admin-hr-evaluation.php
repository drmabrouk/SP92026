...
if (!$can_evaluate) {
    echo '<div style="background:#fee2e2; color:#991b1b; padding:15px; border-radius:8px; border:1px solid #fca5a5; font-weight:700; font-family:\'Cairo\'; text-align:center;">  No  Permissions        .</div>';
    return;
}
...
<div class="sm-content-wrapper" dir="rtl" style="font-family: 'Cairo', sans-serif !important;">
    ...
    <div style="background: #ffffff; padding: 14px 18px; border-radius: 14px; border: 1px solid #e2e8f0; margin-bottom: 14px; box-shadow: 0 4px 18px rgba(0,0,0,0.02); display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 12px;">
        <div style="display: flex; align-items: center; gap: 12px;">
            ...
            <div>
                ...
                <p style="margin: 0; font-size: 11.5px; color: #64748b; font-weight: 500;">              Annual</p>
            </div>
        </div>
        ...
        <div style="display: flex; gap: 10px; align-items: center;">
            <span style="font-size: 12px; font-weight: 800; color: #881337; background: #fef2f2; border: 1px solid #fecdd3; padding: 6px 14px; border-radius: 9999px;">
                  : <?php echo esc_html($active_academic_year); ?>
            </span>
        </div>
    </div>
    ...
    <div id="eval_tab_wizard" style="display: block;">
        <div style="background: #ffffff; padding: 24px; border-radius: 20px; border: 1px solid #e2e8f0; box-shadow: 0 4px 16px rgba(0,0,0,0.02);">
            ...
            <div id="ew_step_1" style="display: block;">
                <h4 style="margin: 0 0 10px 0; font-size: 15px; font-weight: 800; color: #0f172a;"> 1: Search     No </h4>
                <p style="margin: 0 0 16px 0; font-size: 12.5px; color: #64748b;">      No    Users :</p>

                <div style="position: relative; width: 100%; max-width: 480px; margin-bottom: 20px;">
                    <input type="text" id="ew_emp_search_input" onkeyup="eessSearchEmployeeForEval(this.value)" class="sm-input" placeholder="Search    ..." style="height: 42px; border-radius: 9999px !important; border: 1px solid #cbd5e1; padding: 0 36px 0 14px; font-size: 13px; width: 100%; box-sizing: border-box;">
            ...
            <div id="ew_step_2" style="display: none;">
                <h4 style="margin: 0 0 10px 0; font-size: 15px; font-weight: 800; color: #0f172a;"> 2:      </h4>
                <p style="margin: 0 0 16px 0; font-size: 12.5px; color: #64748b;">     No        Training Group Annual :</p>
                ...
                <div style="background: #f0f9ff; border: 1px solid #bae6fd; border-radius: 14px; padding: 18px; margin-bottom: 20px;">
                    <h5 style="margin: 0 0 12px 0; font-size: 13.5px; font-weight: 800; color: #0369a1; display: flex; align-items: center; gap: 6px;">
                        ...
                        <span> Academy  (System Performance Indicators)</span>
                    </h5>
                    ...
                    <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 14px; text-align: center;">
                        ...
                        <div style="background: #ffffff; padding: 12px; border-radius: 10px; border: 1px solid #bae6fd;">
                            <div style="font-size: 11px; color: #64748b; font-weight: 700; margin-bottom: 4px;">   Training Group</div>
                        ...
                        <div style="background: #ffffff; padding: 12px; border-radius: 10px; border: 1px solid #bae6fd;">
                            <div style="font-size: 11px; color: #64748b; font-weight: 700; margin-bottom: 4px;"> No  </div>
                            <div id="ew_sys_overall_score" style="font-size: 20px; font-weight: 900; color: #881337;">100%</div>
                            <small style="font-size: 10px; color: #94a3b8;"> </small>
                        </div>
                    </div>
                </div>

                <!-- Select Category -->
                <h5 style="margin: 0 0 10px 0; font-size: 13.5px; font-weight: 800; color: #0f172a;">    :</h5>
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 12px; margin-bottom: 24px;">
                    <button type="button" onclick="eessSelectEvalCategory(' No ')" class="sm-btn sm-btn-outline" style="height: 48px; border-radius: 12px; font-weight: 800; font-size: 13px; text-align: center; border: 1.5px solid #cbd5e1;">  No </button>
                    <button type="button" onclick="eessSelectEvalCategory('  ')" class="sm-btn sm-btn-outline" style="height: 48px; border-radius: 12px; font-weight: 800; font-size: 13px; text-align: center; border: 1.5px solid #cbd5e1;">   </button>
                    <button type="button" onclick="eessSelectEvalCategory('  ')" class="sm-btn sm-btn-outline" style="height: 48px; border-radius: 12px; font-weight: 800; font-size: 13px; text-align: center; border: 1.5px solid #cbd5e1;">   </button>
                    <button type="button" onclick="eessSelectEvalCategory(' No ')" class="sm-btn sm-btn-outline" style="height: 48px; border-radius: 12px; font-weight: 800; font-size: 13px; text-align: center; border: 1.5px solid #cbd5e1;">   </button>
                </div>

                <div style="display: flex; justify-content: space-between;">
                    <button type="button" onclick="eessGoToEvalStep(1)" class="sm-btn sm-btn-outline" style="height: 38px; border-radius: 9999px !important; font-size: 12px; font-weight: 700;">←   1</button>
                </div>
            </div>
            ...
            <div id="ew_step_3" style="display: none;">
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 16px; border-bottom: 1px solid #f1f5f9; padding-bottom: 10px;">
                    <div>
                        <h4 id="ew_category_title_display" style="margin: 0 0 4px 0; font-size: 15px; font-weight: 800; color: #0f172a;"> 3:   ( 0–10)</h4>
                        <p style="margin: 0; font-size: 12px; color: #64748b;">        ( 0  10):</p>
                    </div>
                    ...
                    <div style="background: #f8fafc; border: 1px solid #e2e8f0; padding: 6px 14px; border-radius: 9999px; font-size: 12px; font-weight: 800; color: #881337;">
                         : <strong id="ew_live_score_sum" style="font-size: 14px;">0 / 100</strong>
                    </div>
                </div>
                ...
                <div style="margin-bottom: 20px;">
                    <label style="display: block; font-size: 12.5px; font-weight: 800; color: #334155; margin-bottom: 6px;">Notes    ():</label>
                    <textarea id="ew_comments_input" rows="3" class="sm-input" placeholder="  Notes       ..." style="width: 100%; border-radius: 10px; border: 1px solid #cbd5e1; padding: 8px 12px; font-size: 12.5px; box-sizing: border-box;"></textarea>
                </div>

                <div style="display: flex; justify-content: space-between;">
                    <button type="button" onclick="eessGoToEvalStep(2)" class="sm-btn sm-btn-outline" style="height: 38px; border-radius: 9999px !important; font-size: 12px; font-weight: 700;">←   2</button>
                    <button type="button" onclick="eessProceedToEvalStep4()" class="sm-btn" style="background: #881337; color: #ffffff !important; height: 38px; border-radius: 9999px !important; padding: 0 24px; font-weight: 800; font-size: 12.5px; border: none; cursor: pointer;">   ←</button>
                </div>
            </div>

            <!-- STEP 4: REVIEW & SUMMARY BEFORE SUBMISSION -->
            <div id="ew_step_4" style="display: none;">
                <h4 style="margin: 0 0 10px 0; font-size: 15px; font-weight: 800; color: #0f172a;"> 4:     Save </h4>
                <p style="margin: 0 0 16px 0; font-size: 12.5px; color: #64748b;">          :</p>
                ...
                <div style="background: #f8fafc; border: 1px solid #cbd5e1; border-radius: 16px; padding: 20px; margin-bottom: 20px;">
                    <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 14px; font-size: 13px; color: #334155; margin-bottom: 16px; border-bottom: 1px solid #e2e8f0; padding-bottom: 12px;">
                        <div> : <strong id="ew_rev_emp_name" style="color: #0f172a;">-</strong></div>
                        <div> : <strong id="ew_rev_category" style="color: #881337;">-</strong></div>
                        <div> : <strong style="color: #0284c7;"><?php echo esc_html($active_academic_year); ?></strong></div>
                        <div> : <strong style="color: #0f172a;"><?php echo esc_html($current_user->display_name); ?></strong></div>
                    </div>
                    ...
                    <div style="display: flex; justify-content: space-between; align-items: center; background: #ffffff; padding: 14px; border-radius: 12px; border: 1px solid #cbd5e1; margin-bottom: 16px;">
                        <div>
                            <span style="font-size: 12px; color: #64748b; font-weight: 700; display: block;">   :</span>
                            <strong id="ew_rev_score_text" style="font-size: 22px; font-weight: 900; color: #16a34a;">0 / 100 (0%)</strong>
                        </div>
                        <span id="ew_rev_status_badge" style="background: #dcfce7; color: #15803d; border: 1px solid #bbf7d0; padding: 4px 14px; border-radius: 9999px; font-weight: 800; font-size: 12px;"></span>
                    </div>
                ...
                <div style="display: flex; justify-content: space-between;">
                    <button type="button" onclick="eessGoToEvalStep(3)" class="sm-btn sm-btn-outline" style="height: 38px; border-radius: 9999px !important; font-size: 12px; font-weight: 700;">←  Edit</button>
        ...
        <div style="background: #ffffff; padding: 24px; border-radius: 20px; border: 1px solid #e2e8f0; box-shadow: 0 4px 16px rgba(0,0,0,0.02);">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 16px; flex-wrap: wrap; gap: 12px;">
                ...
                <div style="display: flex; gap: 10px; align-items: center; flex-wrap: wrap;">
                    <input type="text" id="eval_archive_search" onkeyup="eessLoadEvaluationsArchive()" placeholder="Search    ..." class="sm-input" style="height: 36px; border-radius: 9999px !important; border: 1px solid #cbd5e1; font-size: 12px; padding: 0 14px; width: 220px;">
                ...
                <table style="width: 100%; border-collapse: separate; border-spacing: 0; text-align: right; font-size: 12.5px;">
                    <thead>
                        <tr style="background: #0f172a; color: #ffffff;">
                            <th style="padding: 10px 14px; font-weight: 800; border-radius: 0 8px 0 0;"> </th>
                            <th style="padding: 10px 14px; font-weight: 800;">  </th>
                            <th style="padding: 10px 14px; font-weight: 800;"> </th>
                            <th style="padding: 10px 14px; font-weight: 800; text-align: center;"> </th>
                            <th style="padding: 10px 14px; font-weight: 800; text-align: center;"> </th>
                            <th style="padding: 10px 14px; font-weight: 800; text-align: center; border-radius: 8px 0 0 0;"> </th>
                        </tr>
                    </thead>
    ...
    <div id="eval_tab_templates" style="display: none;">
        <div style="background: #ffffff; padding: 24px; border-radius: 20px; border: 1px solid #e2e8f0; box-shadow: 0 4px 16px rgba(0,0,0,0.02);">
            <h3 style="margin: 0 0 14px 0; font-size: 16px; font-weight: 800; color: #0f172a;">     (0–10)</h3>
            <p style="margin: 0 0 20px 0; font-size: 12.5px; color: #64748b;">Add          Training Group:</p>

            <form id="eess_create_template_form" onsubmit="eessSaveEvalTemplateSubmit(event)">
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 14px; margin-bottom: 16px;">
                    <div>
                        <label style="display: block; font-size: 12px; font-weight: 800; color: #334155; margin-bottom: 4px;">   *</label>
                        <input type="text" id="tmpl_title" required placeholder=":      " class="sm-input" style="width: 100%; height: 40px; border-radius: 8px; border: 1px solid #cbd5e1; padding: 0 12px;">
                    </div>
                    <div>
                        <label style="display: block; font-size: 12px; font-weight: 800; color: #334155; margin-bottom: 4px;">   *</label>
                        <select id="tmpl_role_key" class="sm-select" style="width: 100%; height: 40px; border-radius: 8px; border: 1px solid #cbd5e1; padding: 0 12px;">
                            <option value="sm_teacher"> (sm_teacher)</option>
                            <option value="sm_coordinator">  (sm_coordinator)</option>
                            <option value="sm_supervisor">  (sm_supervisor)</option>
                            <option value="sm_hod">  (sm_hod)</option>
                        </select>
                    </div>
                </div>

                <div style="margin-bottom: 16px;">
                    <label style="display: block; font-size: 12px; font-weight: 800; color: #334155; margin-bottom: 8px;">   ( 0  10 ):</label>
                    <div id="tmpl_questions_builder" style="display: flex; flex-direction: column; gap: 10px;">
                        <input type="text" class="sm-input tmpl-q-input" placeholder=" 1: No   ..." style="height: 38px; border-radius: 8px; border: 1px solid #cbd5e1; padding: 0 12px;">
                        <input type="text" class="sm-input tmpl-q-input" placeholder=" 2:    ..." style="height: 38px; border-radius: 8px; border: 1px solid #cbd5e1; padding: 0 12px;">
                    </div>
                    <button type="button" onclick="eessAddTemplateQuestionRow()" class="sm-btn sm-btn-outline" style="margin-top: 10px; height: 34px; font-size: 11.5px; border-radius: 8px; font-weight: 700;">+ Add  </button>
                </div>

                <button type="submit" id="tmpl_save_btn" class="sm-btn" style="background: #881337; color: #ffffff !important; height: 40px; border-radius: 9999px !important; padding: 0 24px; font-weight: 800; font-size: 12.5px; border: none; cursor: pointer;">Save   </button>
            </form>
        </div>
    </div>
    <?php endif; ?>
...
function eessSearchEmployeeForEval(query) {
    ...
    if (!query || query.length < 1) {
        grid.innerHTML = '<div style="color:#94a3b8; font-size:12px; grid-column: span 3;">    Search  ...</div>';
        return;
    }
    ...
    .then(res => {
        if (res.success && res.data && res.data.length > 0) {
                ...
                html += `
                    <div onclick='eessSelectEmployeeForEval(${JSON.stringify(emp)})' style="background:#ffffff; border:1px solid #cbd5e1; border-radius:12px; padding:12px; display:flex; align-items:center; gap:12px; cursor:pointer; transition:border-color 0.2s;" onmouseover="this.style.borderColor='#881337'" onmouseout="this.style.borderColor='#cbd5e1'">
                        ...
                        <div>
                            ...
                            <small style="color:#64748b; font-size:11px;">: ${emp.employee_number} | ${emp.department}</small>
                        </div>
                    </div>
                `;
            });
            ...
            grid.innerHTML = '<div style="color:#94a3b8; font-size:12px; grid-column: span 3;">     .</div>';
        }
    });
}
...
function eessSelectEmployeeForEval(emp) {
    ...
    document.getElementById('ew_s_emp_id').innerText = ': ' + emp.employee_number;
...
function eessProceedToEvalStep2() {
    ...
    .then(res => {
        if (res.success && res.data) {
            ...
            document.getElementById('ew_sys_prep_sub').innerText = d.prep_ontime + '     ' + d.prep_total;
            document.getElementById('ew_sys_plan_pct').innerText = d.plan_compliance_pct + '%';
            document.getElementById('ew_sys_plan_sub').innerText = d.plan_approved + '     ' + d.plan_total;
...
function eessSelectEvalCategory(categoryName) {
    ...
    .then(res => {
        if (res.success && res.data) {
            ...
            document.getElementById('ew_category_title_display').innerText = categoryName + ' — : ' + eessSelectedEmployee.name;
...
function eessSubmitFinalEvaluation() {
    ...
    .then(res => {
        ...
        if (res.success) {
            if (typeof smShowNotification === 'function') smShowNotification(' Save    ');
...
function eessLoadEvaluationsArchive() {
    ...
    .then(res => {
        if (res.success && res.data && res.data.length > 0) {
            ...
            res.data.forEach(function(row) {
                html += `
                    <tr style="border-bottom:1px solid #f1f5f9;">
                        <td style="padding:10px 14px;"><strong>${row.employee_name}</strong> <small style="color:#64748b;">(: ${row.employee_number})</small></td>
                        ...
                        <td style="padding:10px 14px; text-align:center;"><strong style="color:#16a34a; font-size:14px;">${row.average_pct}%</strong> (${row.total_score} )</td>
            ...
            tbody.innerHTML = '<tr><td colspan="6" style="padding:30px; text-align:center; color:#94a3b8;">No     .</td></tr>';
        }
    });
}
