...
<body>
    ...
    <div class="print-header">
        ...
        <div style="text-align: left;">
            ...
            <div style="font-size: 0.9em;"> : <?php echo date_i18n('j F Y'); ?></div>
        </div>
    </div>
        ...
        <tbody>
            ...
            <?php else: ?>
                ...
                <tr>
                    ...
                    <td>
                        <?php if ($report_type === 'daily'): ?>
                             : <?php echo (int)$row->total_absences; ?>
                        <?php else: ?>
                            <strong><?php echo (int)$row->absence_count; ?> </strong>
                        <?php endif; ?>
                    </td>
                </tr>
                <?php endforeach; ?>
