...
<div class="sm-content-wrapper" dir="rtl" style="font-family: 'Cairo', sans-serif !important;">
    ...
    <div style="background: #ffffff; padding: 20px 24px; border-radius: 20px; border: 1px solid #e2e8f0; margin-bottom: 18px; box-shadow: 0 4px 18px rgba(0,0,0,0.02); display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 16px;">
        <div style="display: flex; align-items: center; gap: 14px;">
            ...
            <div>
                <h2 style="margin: 0 0 4px 0; font-size: 20px; font-weight: 800; color: #0f172a;">Dashboard Home  </h2>
                <p style="margin: 0; font-size: 12.5px; color: #64748b; font-weight: 500;">   Attendance Rate      </p>
            </div>
        </div>
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(240px, 1fr)); gap: 16px; margin-bottom: 25px;">
        ...
        <div style="background: #ffffff; border-radius: 16px; padding: 20px; border: 1px solid #cbd5e1; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.05); border-top: 4px solid #2563eb;">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
                <span style="font-size: 12px; font-weight: 800; color: #64748b;">  / </span>
        ...
        <div style="background: #ffffff; border-radius: 16px; padding: 20px; border: 1px solid #cbd5e1; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.05); border-top: 4px solid #16a34a;">
            ...
            <div style="font-size: 11px; color: #64748b; display: flex; gap: 8px;">
                <span>: <strong><?php echo $att['present']; ?></strong></span>
                <span>: <strong><?php echo $att['absent']; ?></strong></span>
                <span>: <strong><?php echo $att['total_students']; ?></strong></span>
            </div>
        </div>
        ...
        <a href="<?php echo add_query_arg('sm_tab', 'lesson-plans'); ?>" style="text-decoration: none; background: #ffffff; border-radius: 16px; padding: 20px; border: 1px solid #cbd5e1; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.05); border-top: 4px solid #f59e0b; display: block;">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
                <span style="font-size: 12px; font-weight: 800; color: #64748b;">   No</span>
...
<?php else: ?>
    ...
    <div class="sm-card-grid" style="margin-bottom: 30px;">
        <div class="sm-stat-card" style="border-top: 4px solid var(--sm-primary-color); border-radius: 8px; box-shadow: 0 4px 6px rgba(0,0,0,0.02);">
            <div style="font-size: 0.9em; color: var(--sm-text-gray); margin-bottom: 8px; font-weight: 700;"> No</div>
        ...
        <div class="sm-stat-card" style="border-top: 4px solid var(--sm-secondary-color); border-radius: 8px; box-shadow: 0 4px 6px rgba(0,0,0,0.02);">
            <div style="font-size: 0.9em; color: var(--sm-text-gray); margin-bottom: 8px; font-weight: 700;"> </div>
        ...
        <div class="sm-stat-card" style="border-top: 4px solid var(--sm-dark-color); border-radius: 8px; box-shadow: 0 4px 6px rgba(0,0,0,0.02);">
            <div style="font-size: 0.9em; color: var(--sm-text-gray); margin-bottom: 8px; font-weight: 700;">Actions </div>
...
<div style="display: grid; grid-template-columns: 2fr 1fr; gap: 20px; margin-bottom: 30px;">
    ...
    <div style="background: #fff; padding: 20px; border-radius: 8px; border: 1px solid var(--sm-border-color); position: relative; max-height: 300px; overflow: hidden;">
        <div style="display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid #eee; padding-bottom: 10px; margin-bottom: 10px;">
            <h3 style="margin:0; font-size: 1.0em;">  ( 30 )</h3>
            <button onclick="smDownloadChart('violationTrendsChart', '_')" class="sm-action-btn" title="Upload " style="background:none; border:none; color:var(--sm-text-gray); cursor:pointer;"><span class="dashicons dashicons-download"></span></button>
        </div>
    ...
    <div style="background: #fff; padding: 20px; border-radius: 16px; border: 1px solid #e2e8f0; position: relative; max-height: 300px; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.02); display: flex; flex-direction: column;">
        <div style="display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid #f1f5f9; padding-bottom: 10px; margin-bottom: 12px;">
            ...
            <span style="font-size: 11px; color: #64748b; font-weight: 700;"> 3 </span>
        </div>
        ...
        <div style="flex: 1; overflow-y: auto; display: flex; flex-direction: column; gap: 8px;">
            ...
            if (empty($latest_support)): ?>
                <div style="padding: 30px; text-align: center; color: #94a3b8; font-size: 12px; font-weight: 600;">No       .</div>
            <?php else:
                $pastel_colors = array(
                    array('bg' => '#f0f9ff', 'border' => '#bae6fd', 'text' => '#0369a1', 'tag' => 'Update '),
                    array('bg' => '#f0fdf4', 'border' => '#bbf7d0', 'text' => '#15803d', 'tag' => ' '),
                    array('bg' => '#fffbeb', 'border' => '#fef3c7', 'text' => '#b45309', 'tag' => ' ')
                );
                $idx = 0;
    ...
    <div style="background: #ffffff; border-radius: 20px; max-width: 520px; width: 100%; border: 1px solid #cbd5e1; box-shadow: 0 25px 50px -12px rgba(0, 0, 0, 0.3); overflow: hidden; display: flex; flex-direction: column;">
        <div style="background: #0f172a; color: #ffffff; padding: 16px 22px; display: flex; justify-content: space-between; align-items: center; width: 100%; box-sizing: border-box;">
            <div style="display: flex; align-items: center; gap: 10px;">
                ...
                <h3 style="margin: 0; font-size: 15.5px; font-weight: 800; color: #ffffff;" id="m_sup_modal_title">  </h3>
            </div>
        ...
        <div style="padding: 22px;">
            ...
            <div style="display: flex; justify-content: flex-end;">
                <button type="button" onclick="document.getElementById('eess-support-update-modal').style.display='none'" class="sm-btn" style="height: 38px; padding: 0 24px; border-radius: 9999px !important; font-size: 12.5px; background: #000000; color: #ffffff !important; font-weight: 800; border: none; cursor: pointer;">Close </button>
            </div>
        </div>
    </div>
</div>
...
function eessOpenSupportUpdateModal(title, details, dateStr) {
    ...
    document.getElementById('m_sup_modal_date').innerText = ' : ' + dateStr;
    ...
    <div style="background: #ffffff; border-radius: 20px; max-width: 520px; width: 100%; border: 1px solid #cbd5e1; box-shadow: 0 25px 50px -12px rgba(0, 0, 0, 0.3); overflow: hidden; display: flex; flex-direction: column;">
        <div style="background: #0f172a; color: #ffffff; padding: 16px 22px; display: flex; justify-content: space-between; align-items: center; width: 100%; box-sizing: border-box;">
            <div style="display: flex; align-items: center; gap: 10px;">
                ...
                <h3 style="margin: 0; font-size: 15.5px; font-weight: 800; color: #ffffff;">Send No    Mother</h3>
            </div>
        ...
        <div style="padding: 22px;">
            <div style="margin-bottom: 16px;">
                <label style="display: block; font-size: 12px; font-weight: 700; color: #334155; margin-bottom: 6px;"> No  *</label>
            ...
            <div style="margin-bottom: 20px;">
                <label style="display: block; font-size: 12px; font-weight: 700; color: #334155; margin-bottom: 6px;"> No  No *</label>
                <textarea id="eess_note_text" rows="4" class="sm-textarea" placeholder=" No     Mother ..." style="width: 100%; border-radius: 12px; border: 1px solid #cbd5e1; padding: 12px; font-size: 13px; box-sizing: border-box;"></textarea>
            </div>
            ...
            <div style="display: flex; justify-content: flex-end; gap: 10px;">
                ...
                <button type="button" id="eess-btn-send-note" onclick="eessSubmitQuickParentNote()" class="sm-btn" style="height: 38px; padding: 0 24px; border-radius: 9999px !important; font-size: 12.5px; background: #881337; color: #ffffff !important; font-weight: 800; border: none; cursor: pointer;">Send No </button>
            </div>
        </div>
    </div>
</div>
...
function eessSubmitQuickParentNote() {
    ...
    .then(res => {
        btn.disabled = false;
        btn.innerText = 'Send No ';

        if (res.success) {
            if (typeof smShowNotification === 'function') {
                smShowNotification(res.data.message || ' Send No    Mother');
            } else {
                alert(res.data.message || ' Send No    Mother');
            }
            document.getElementById('eess-quick-parent-note-modal').style.display = 'none';
            document.getElementById('eess_note_text').value = '';
        } else {
            if (typeof smShowNotification === 'function') {
                smShowNotification(res.data || 'An error occurred  Send No', true);
            } else {
                alert(res.data || 'An error occurred  Send No');
            }
        }
    });
}
