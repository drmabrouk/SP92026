...
<head>
    <meta charset="UTF-8">
    <title>   - <?php echo esc_html($date); ?></title>
...
<body>
    <div class="no-print" style="background: #f8fafc; padding: 20px; text-align: center; border-bottom: 1px solid #e2e8f0; margin-bottom: 30px;">
        <button onclick="window.print()" style="padding: 12px 30px; background: #38a169; color: white; border: none; border-radius: 8px; font-weight: 800; cursor: pointer; font-family: 'Rubik', sans-serif;"> Print </button>
    </div>
    ...
    <div class="grade-summary">
        ...
        <div class="report-title">
            <h2><?php echo esc_html($curr_grade); ?><?php echo $curr_section ? ' -  ' . esc_html($curr_section) : ''; ?></h2>
        </div>

        <div class="report-meta">
            <span> No: <?php echo count($students); ?></span>
            <span>: <?php echo count(array_filter($students, function($s) { return $s->status == 'present'; })); ?></span>
            <span>: <?php echo count(array_filter($students, function($s) { return $s->status == 'absent'; })); ?></span>
        </div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        $class = '';
                        switch($s->status) {
                            case 'present': $status_label = ''; $class = 'status-present'; break;
                            case 'absent': $status_label = ''; $class = 'status-absent'; break;
                            case 'late': $status_label = ''; $class = 'status-late'; break;
                            case 'excused': $status_label = ''; $class = 'status-excused'; break;
                        }
                        ?>
        ...
        <div style="margin-top: 40px; display: flex; justify-content: space-between; align-items: flex-start;">
            <div style="text-align: center;">
                <p style="font-weight: 800; margin-bottom: 30px;">  Training Group</p>
                <p>............................</p>
            </div>
            <div style="text-align: center;">
                <p style="font-weight: 800; margin-bottom: 10px;">  Academy </p>
