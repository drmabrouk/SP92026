...
<div class="sm-content-wrapper" dir="rtl" style="font-family: 'Cairo', sans-serif !important;">
    ...
    <div style="background: #ffffff; padding: 20px 24px; border-radius: 20px; border: 1px solid #e2e8f0; margin-bottom: 18px; box-shadow: 0 4px 18px rgba(0,0,0,0.02); display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 16px;">
        <div style="display: flex; align-items: center; gap: 14px;">
            ...
            <div>
                <h2 style="margin: 0 0 4px 0; font-size: 20px; font-weight: 800; color: #0f172a;">  Mother </h2>
                <p style="margin: 0; font-size: 12.5px; color: #64748b; font-weight: 500;"> No  No  Mother     No </p>
            </div>
        </div>

        <?php if (current_user_can('manage_options') || current_user_can('__Mother')): ?>
    ...
    <div style="background: #ffffff; padding: 18px 22px; border-radius: 16px; border: 1px solid #e2e8f0; margin-bottom: 20px; box-shadow: 0 2px 8px rgba(0,0,0,0.02);">
        <form method="get" style="display: flex; gap: 14px; align-items: center; flex-wrap: wrap;">
            <div style="flex: 1; min-width: 280px;">
                <label class="sm-label" style="font-size: 12px; font-weight: 700; color: #334155; margin-bottom: 4px; display: block;">Search    (No    Player Name):</label>
                <input type="text" name="parent_search" class="sm-input" value="<?php echo esc_attr(isset($_GET['parent_search']) ? $_GET['parent_search'] : ''); ?>" placeholder="   Mother   No..." style="height: 38px; border-radius: 9999px !important; border: 1px solid #cbd5e1; padding: 0 16px; font-size: 12.5px;">
            </div>
            <div style="display: flex; gap: 8px; align-self: flex-end;">
                <button type="submit" class="sm-btn" style="background: #1e293b; color: #fff !important; height: 38px; border-radius: 9999px !important; padding: 0 20px; font-weight: 800; font-size: 12.5px; border: none; cursor: pointer;"> Search</button>
                ...
                <div class="sm-parent-row" style="background: #fff; border-radius: 12px; border: 1px solid var(--sm-border-color); padding: 20px 30px; display: flex; align-items: center; justify-content: space-between; transition: 0.3s; gap: 20px;">
                    ...
                    <div style="flex: 2; background: #f8fafc; padding: 10px 15px; border-radius: 8px; border: 1px solid #edf2f7; font-size: 0.9em;">
                        ...
                        <?php if (empty($children)): ?>
                            <span style="color: #e53e3e; font-size: 12px; margin-right: 10px;">No   </span>
                        <?php else: ?>
                    ...
                    <div style="flex: 1; display: flex; gap: 8px; justify-content: flex-end; align-items: center;">
                        <?php
                            ...
                            if (!empty($formatted_phone)):
                                $wa_msg = rawurlencode("No     / / " . $parent->display_name);
                        ?>
                            <a href="https://wa.me/<?php echo $formatted_phone; ?>?text=<?php echo $wa_msg; ?>" target="_blank" title="  " style="width: 36px; height: 36px; border-radius: 50% !important; background: #dcfce7; color: #16a34a; border: 1px solid #86efac; display: inline-flex; align-items: center; justify-content: center; text-decoration: none; transition: transform 0.2s;" onmouseover="this.style.transform='scale(1.08)'" onmouseout="this.style.transform='scale(1)'">
                                <span class="dashicons dashicons-whatsapp" style="font-size: 18px; width: 18px; height: 18px; margin: 0;"></span>
                            </a>
                        <?php endif; ?>

                        <button onclick="requestCallIn(<?php echo $parent->ID; ?>, '<?php echo esc_js($parent->display_name); ?>', '<?php echo esc_js($parent->user_email); ?>', '<?php echo esc_js($formatted_phone ?: ''); ?>')" title="   Mother" style="width: 36px; height: 36px; border-radius: 50% !important; background: #eff6ff; color: #2563eb; border: 1px solid #bfdbfe; display: inline-flex; align-items: center; justify-content: center; cursor: pointer; transition: transform 0.2s;" onmouseover="this.style.transform='scale(1.08)'" onmouseout="this.style.transform='scale(1)'">
    ...
    <div id="add-parent-modal" class="sm-modal-overlay">
        <div class="sm-modal-content">
            ...
            <form id="add-parent-form">
                ...
                <p style="font-size:12px; color:#718096; margin-top:15px;">No:   Mother No    No   "Manage Players".</p>
                <button type="submit" class="sm-btn" style="margin-top:20px; width: 100%;">  </button>
            </form>
        </div>
    </div>
    ...
    <div id="call-in-modal" class="sm-modal-overlay">
        <div class="sm-modal-content" style="max-width: 580px;">
            <div class="sm-modal-header">
                <h3 style="margin: 0; font-size: 16px; font-weight: 800; color: #881337;">Issue     Mother</h3>
            ...
            <form id="eess-parent-summons-form" style="padding: 10px 0;">
                ...
                <p style="font-size: 13px; color: #475569; margin-bottom: 15px;">   Mother: <strong id="call_in_parent_name" style="color: #881337;"></strong></p>

                <div class="sm-form-group" style="text-align: right; margin-bottom: 12px;">
                    <label class="sm-label" style="font-size: 12px; font-weight: 700;"> No  No:</label>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px; margin-bottom: 12px; text-align: right;">
                    <div>
                        <label class="sm-label" style="font-size: 12px; font-weight: 700;"> :</label>
                ...
                <div class="sm-form-group" style="text-align: right; margin-bottom: 12px;">
                    <label class="sm-label" style="font-size: 12px; font-weight: 700;"> No :</label>
                    <input type="text" id="summons_reason" name="reason" class="sm-input" placeholder=":  Level  No No" style="height: 40px; font-size: 12.5px;" required>
                </div>

                <div class="sm-form-group" style="text-align: right; margin-bottom: 15px;">
                    <label class="sm-label" style="font-size: 12px; font-weight: 700;">    Mother:</label>
                    <textarea id="call_in_msg_text" class="sm-textarea" rows="3" style="font-size: 12px; line-height: 1.6;">       Academy      /.  .</textarea>
                </div>

                <div style="display: flex; gap: 10px; justify-content: flex-end; flex-wrap: wrap;">
                    <button type="submit" class="sm-btn" style="background: #881337; color: white; width: auto; height: 38px; padding: 0 20px; font-weight: 800; font-size: 12.5px;">Save Issue No</button>
                    <button type="button" onclick="sendCallViaWhatsApp()" class="sm-btn" style="background: #16a34a; color: white; width: auto; height: 38px; padding: 0 16px; font-weight: 800; font-size: 12.5px; display: inline-flex; align-items: center; gap: 6px;">
                        <span class="dashicons dashicons-whatsapp"></span> Send
                    </button>
    ...
    <div id="eess-parent-visit-modal" class="sm-modal-overlay" style="display: none;">
        <div class="sm-modal-content" style="max-width: 580px;">
            <div class="sm-modal-header">
                <h3 style="margin: 0; font-size: 16px; font-weight: 800; color: #16a34a;"> No      </h3>
            ...
            <form id="eess-parent-visit-form" style="padding: 10px 0;">
                ...
                <div class="sm-form-group" style="text-align: right; margin-bottom: 12px;">
                    <label class="sm-label" style="font-size: 12px; font-weight: 700;">No    No  No :</label>
                    <textarea id="visit_discussion_summary" name="discussion_summary" class="sm-textarea" rows="3" style="font-size: 12.5px;" placeholder="       Mother  ..." required></textarea>
                </div>

                <div class="sm-form-group" style="text-align: right; margin-bottom: 12px;">
                    <label class="sm-label" style="font-size: 12px; font-weight: 700;">    Mother (Parent Cooperation):</label>
                ...
                <div class="sm-form-group" style="text-align: right; margin-bottom: 15px;">
                    <label class="sm-label" style="font-size: 12px; font-weight: 700;">Notes  :</label>
                    <textarea id="visit_evaluation_comments" name="evaluation_comments" class="sm-textarea" rows="2" style="font-size: 12px;" placeholder="    No   Academy ..."></textarea>
                </div>

                <div style="display: flex; gap: 10px; justify-content: flex-end;">
                    <button type="submit" class="sm-btn" style="background: #16a34a; color: white; width: auto; height: 38px; padding: 0 20px; font-weight: 800; font-size: 12.5px;">Confirm   </button>
    ...
    function requestCallIn(id, name, email, phone) {
        ...
        stuSelect.innerHTML = '<option value=""> Upload Father ...</option>';
        ...
        .then(res => {
            if (res.success && res.data && res.data.length > 0) {
                ...
                stuSelect.innerHTML = '<option value="0">    No  </option>';
            }
        })
        .catch(() => {
            stuSelect.innerHTML = '<option value="0"> -    Mother</option>';
        });
    ...
    document.getElementById('eess-parent-summons-form').addEventListener('submit', function(e) {
        ...
        .then(res => {
            if (res.success) {
                ...
                alert(res.data || 'An error occurred  Issue No');
            }
        });
    });
    ...
    function sendCallViaEmail() {
        const msg = encodeURIComponent(document.getElementById('call_in_msg_text').value);
        const subject = encodeURIComponent('    Academy ');
