...
<div class="sm-container" style="padding: 10px 0; font-family: 'Cairo', sans-serif !important; direction: rtl;">
    ...
    <div style="background: #ffffff; padding: 20px 24px; border-radius: 20px; border: 1px solid #e2e8f0; margin-bottom: 18px; box-shadow: 0 4px 18px rgba(0,0,0,0.02); display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 16px;">
        <div style="display: flex; align-items: center; gap: 14px;">
            ...
            <div>
                <h2 style="margin: 0 0 4px 0; font-size: 20px; font-weight: 800; color: #0f172a;">System Settings  </h2>
    ...
    <div style="background: #ffffff; border-radius: 14px; padding: 16px 18px; border: 1px solid #e2e8f0; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.05); margin-bottom: 16px;">
        ...
        <form id="eess-announcement-form" onsubmit="eessCreateAnnouncement(event)">
            ...
            <div style="display: grid; grid-template-columns: 2fr 1fr; gap: 20px; margin-bottom: 20px;">
                <div>
                    <label style="display: block; font-size: 13px; font-weight: 700; color: #334155; margin-bottom: 6px;">  /  <span style="color:#ef4444;">*</span></label>
                    <input type="text" name="title" required placeholder=":     No " style="width: 100%; height: 34px; border: 1px solid #cbd5e1; border-radius: 8px; padding: 0 10px; font-size: 12px; box-sizing: border-box;">
                </div>
                <div>
                    <label style="display: block; font-size: 13px; font-weight: 700; color: #334155; margin-bottom: 6px;">  / </label>
            ...
            <div style="margin-bottom: 20px;">
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 6px;">
                    <label style="font-size: 13px; font-weight: 700; color: #334155;">  (  500 ) <span style="color:#ef4444;">*</span></label>
                    <span id="char-counter" style="font-size: 12px; font-weight: 700; color: #64748b;">0 / 500</span>
                </div>
                <textarea name="details" id="announcement-details" required maxlength="500" rows="4" placeholder="    ..." oninput="document.getElementById('char-counter').innerText = this.value.length + ' / 500'" style="width: 100%; border: 1px solid #cbd5e1; border-radius: 8px; padding: 10px; font-size: 13px; box-sizing: border-box;"></textarea>
            </div>

            <div style="margin-bottom: 20px;">
                <label style="display: block; font-size: 13px; font-weight: 700; color: #334155; margin-bottom: 10px;">   <span style="color:#ef4444;">*</span></label>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 25px;">
                <div>
                    <label style="display: block; font-size: 13px; font-weight: 700; color: #334155; margin-bottom: 6px;"> View  ()</label>
    ...
    <div style="background: #ffffff; border-radius: 16px; padding: 25px; border: 1px solid #e2e8f0; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.05); margin-bottom: 30px;">
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px; border-bottom: 2px solid #f1f5f9; padding-bottom: 10px; flex-wrap: wrap; gap: 10px;">
            ...
            <div style="display: flex; gap: 8px;">
                <button type="button" onclick="eessBulkDeleteReadStats()" class="sm-btn" style="background: #fee2e2; color: #b91c1c !important; border: 1px solid #fca5a5; height: 32px; padding: 0 14px; font-size: 11px; border-radius: 9999px; font-weight: 800; cursor: pointer;" title=" No   Users ">
                    ️
                </button>
            </div>
        </div>
            ...
            <table class="sm-table" style="width: 100%; border-collapse: collapse; font-size: 11.5px;">
                ...
                <tbody>
                    <?php if (empty($announcements)): ?>
                        <tr><td colspan="7" style="padding: 20px; text-align: center; color: #94a3b8;">No    .</td></tr>
                    <?php else: ?>
                        ...
                        ?>
                            <tr style="border-bottom: 1px solid #f1f5f9;">
                                ...
                                <td style="padding: 12px; text-align: center;">
                                    ...
                                    <?php else: ?>
                                        <span style="background: #fee2e2; color: #991b1b; padding: 4px 10px; border-radius: 50px; font-weight: 800; font-size: 11px;"> (Disabled)</span>
                                    <?php endif; ?>
                                </td>
                                <td style="padding: 12px; text-align: center; display: flex; gap: 6px; justify-content: center;">
                                    <?php if ($is_active): ?>
                                        <button type="button" onclick="eessDisableAnnouncement(<?php echo $anc->id; ?>)" style="background: #ef4444; color: white; border: none; border-radius: 6px; padding: 5px 10px; font-size: 11px; font-weight: 700; cursor: pointer; display: inline-flex; align-items: center; gap: 4px;" title="   ">
                                            <span class="dashicons dashicons-no-alt" style="font-size: 14px; width: 14px; height: 14px;"></span>

                                        </button>
                                    <?php else: ?>
                                        <button type="button" onclick="eessRepublishAnnouncement(<?php echo $anc->id; ?>)" style="background: #16a34a; color: white; border: none; border-radius: 6px; padding: 5px 10px; font-size: 11px; font-weight: 700; cursor: pointer; display: inline-flex; align-items: center; gap: 4px;" title="       ">
    ...
    <div style="background: #ffffff; border-radius: 16px; padding: 25px; border: 1px solid #e2e8f0; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.05); margin-bottom: 30px;">
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px; border-bottom: 2px solid #f1f5f9; padding-bottom: 10px; flex-wrap: wrap; gap: 10px;">
            <h3 style="margin: 0; font-size: 16px; font-weight: 800; color: #0f172a; display: flex; align-items: center; gap: 8px;">
                ...
                <span>  Users     (Show Again)</span>
            </h3>
            <div style="display: flex; gap: 8px;">
                <button type="button" onclick="eessBulkDeleteUserInteractions()" class="sm-btn" style="background: #fee2e2; color: #b91c1c !important; border: 1px solid #fca5a5; height: 32px; padding: 0 14px; font-size: 11px; border-radius: 9999px; font-weight: 800; cursor: pointer;" title="  No   Users ">
                    ️  No Users
                </button>
            </div>
        </div>
            ...
            <table class="sm-table" style="width: 100%; border-collapse: collapse; font-size: 12px;">
                ...
                <tbody>
                    <?php if (empty($activity_logs)): ?>
                        <tr><td colspan="6" style="padding: 20px; text-align: center; color: #94a3b8;">No  No   .</td></tr>
                    <?php else: ?>
                            ...
                            <tr id="user-log-row-<?php echo $log->id; ?>" style="border-bottom: 1px solid #f1f5f9;">
                                ...
                                <td style="padding: 12px; text-align: center;">
                                    <?php if ($log->status === 'closed'): ?>
                                        <span style="background: #fee2e2; color: #991b1b; padding: 4px 10px; border-radius: 50px; font-weight: 800; font-size: 11px;"></span>
                                    <?php elseif ($log->status === 'viewed'): ?>
                                        <span style="background: #dbeafe; color: #1e40af; padding: 4px 10px; border-radius: 50px; font-weight: 800; font-size: 11px;"> </span>
                                    <?php else: ?>
    ...
    <div id="eess-support-management-card" style="background: #ffffff; border-radius: 16px; padding: 25px; border: 1px solid #e2e8f0; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.05);">
        ...
        <form method="get" style="display: flex; gap: 15px; flex-wrap: wrap; margin-bottom: 20px; background: #f8fafc; padding: 15px; border-radius: 12px; border: 1px solid #e2e8f0;">
            ...
            <div style="flex: 1; min-width: 200px;">
                <label style="display: block; font-size: 11px; font-weight: 700; color: #475569; margin-bottom: 4px;">Search </label>
                <input type="text" name="support_search" value="<?php echo esc_attr($s_search); ?>" placeholder="    Address..." class="sm-input" style="height: 38px; font-size: 12px; width: 100%;">
            </div>

            <div style="width: 180px;">
                <label style="display: block; font-size: 11px; font-weight: 700; color: #475569; margin-bottom: 4px;"> </label>
                <select name="support_cat" class="sm-select" style="height: 38px; font-size: 12px; width: 100%;">
                    <option value="all" <?php selected($s_cat, 'all'); ?>> (All)</option>
                    <option value="suggestion" <?php selected($s_cat, 'suggestion'); ?>> (Suggestions)</option>
                    <option value="technical_issue" <?php selected($s_cat, 'technical_issue'); ?>>  (Technical Issues)</option>
                    <option value="rating" <?php selected($s_cat, 'rating'); ?>>  (Ratings)</option>
                </select>
            </div>
                ...
                <tbody>
                    ...
                    <?php else: ?>
                        <?php foreach ($support_requests as $s_req):
                            ...
                            $cat_map = array(
                                'suggestion'      => array('label' => '', 'bg' => '#fef3c7', 'color' => '#92400e'),
                                'technical_issue' => array('label' => ' ', 'bg' => '#fee2e2', 'color' => '#991b1b'),
                                'rating'          => array('label' => ' ', 'bg' => '#dbeafe', 'color' => '#1e40af'),
                            );
                            $cat_badge = $cat_map[$s_req->category] ?? array('label' => $s_req->category, 'bg' => '#f1f5f9', 'color' => '#475569');

                            $status_map = array(
                                'new'         => array('label' => '', 'bg' => '#fef9c3', 'color' => '#a16207'),
                                'in_progress' => array('label' => ' ', 'bg' => '#e0f2fe', 'color' => '#0369a1'),
                                'resolved'    => array('label' => ' ', 'bg' => '#dcfce7', 'color' => '#15803d'),
                                'closed'      => array('label' => '', 'bg' => '#f1f5f9', 'color' => '#475569'),
                            );
                        ...
                        ?>
                            <tr id="support-req-row-<?php echo $s_req->id; ?>" style="border-bottom: 1px solid #f1f5f9;">
                                <td style="padding: 12px; font-weight: 700; color: #0f172a;">
                                    ...
                                    <div style="font-size: 10px; color: #64748b; font-weight: normal; margin-top: 2px;"> : <?php echo esc_html($sender_emp_id); ?></div>
                                </td>
                                ...
                                <td style="padding: 12px; text-align: center;">
                                    <?php if (!empty($s_req->attachment_url)): ?>
                                        <a href="<?php echo esc_url($s_req->attachment_url); ?>" target="_blank" style="color: #2563eb; text-decoration: underline; font-weight: 700;">️ View </a>
                                    <?php else: ?>
...
<div id="eess-view-support-modal" style="display: none; position: fixed; inset: 0; width: 100vw; height: 100vh; background: rgba(15, 23, 42, 0.7); backdrop-filter: blur(5px); z-index: 999999; justify-content: center; align-items: center; padding: 20px; box-sizing: border-box; font-family: 'Cairo', sans-serif; direction: rtl;">
    <div style="background: #ffffff; border-radius: 16px; max-width: 600px; width: 100%; border: 1px solid #cbd5e1; box-shadow: 0 25px 50px -12px rgba(0, 0, 0, 0.25); overflow: hidden; display: flex; flex-direction: column; max-height: 90vh;">
        <div style="background: #1e293b; color: #ffffff; padding: 18px 20px; display: flex; justify-content: space-between; align-items: center;">
            <h3 style="margin: 0; font-size: 15px; font-weight: 800;">   / </h3>
...
const eessSupportRequestsJS = <?php
    ...
    if (!empty($support_requests)) {
        foreach ($support_requests as $s_r) {
            ...
            $role_label = !empty($roles) ? ($roles_list[reset($roles)] ?? reset($roles)) : ' ';
            $inst = get_user_meta($s_r->user_id, 'eess_school_name', true) ?: (get_user_meta($s_r->user_id, 'institution', true) ?: ' ');
    ...
    if (data.attachment_url) {
        attachmentHtml = `
            <div style="margin-top: 15px; border-top: 1px solid #cbd5e1; padding-top: 12px;">
                <strong style="display: block; font-size: 12px; color: #334155; margin-bottom: 8px;">  / :</strong>
    ...
    if (data.category === 'rating' && data.rating_stars > 0) {
        starsHtml = `
            <div style="margin-bottom: 12px;">
                <strong>:</strong> <span style="color: #f59e0b; font-size: 16px;">${'★'.repeat(data.rating_stars)}${'☆'.repeat(5 - data.rating_stars)}</span> (${data.rating_stars}  5)
            </div>
        `;
    }
    ...
    const html = `
        <div style="background: #f8fafc; padding: 15px; border-radius: 10px; border: 1px solid #e2e8f0; margin-bottom: 15px; font-size: 12px; line-height: 1.8;">
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px;">
                <div><strong>:</strong> ${data.sender_name}</div>
                <div><strong> :</strong> ${data.sender_role}</div>
                <div><strong>Organization /Academy :</strong> ${data.institution}</div>
                <div><strong>:</strong> ${data.created_at}</div>
            </div>
        </div>
        ...
        <div style="margin-bottom: 15px;">
            <strong style="display: block; font-size: 13px; color: #0f172a; margin-bottom: 6px;"> :</strong>
        ...
        <div style="margin-top: 20px; border-top: 2px dashed #cbd5e1; padding-top: 15px;">
            <label style="display: block; font-size: 12px; font-weight: 800; color: #0f172a; margin-bottom: 6px;">Update  :</label>
            <div style="display: flex; gap: 10px; align-items: center;">
                ...
                <button type="button" onclick="eessSaveSupportStatus(${data.id})" class="sm-btn" style="background: #16a34a; height: 38px; font-size: 12px; padding: 0 16px;"> Status</button>
            </div>
        </div>
    `;
...
function eessCreateAnnouncement(e) {
    ...
    jQuery.post('<?php echo admin_url('admin-ajax.php'); ?>', formData, function(res) {
        btn.disabled = false;
        btn.innerHTML = '<span class="dashicons dashicons-send"></span>   ';

        statusBox.style.display = 'block';
        if (res.success) {
            statusBox.style.background = '#f0fdf4';
            statusBox.style.color = '#166534';
            statusBox.innerText = res.data.message || '   !';
...
function eessDeleteAnnouncement(ancId) {
    if (!confirm(' :     Delete     Delete      .')) return;
    ...
    jQuery.post('<?php echo admin_url('admin-ajax.php'); ?>', {
        ...
        if (res.success) {
            alert(res.data.message || ' Delete  .');
            location.reload();
        } else {
            alert(res.data || 'An error occurred  Delete .');
        }
    });
}
