...
<body onload="window.print()">
    ...
    <div class="doc-header">
        ...
        <div style="text-align: left;">
            ...
            <?php else: ?>
                <div style="font-size: 11px; color: #64748b;">منظومة تقديم تقارير أعضاء هيئة التدريب والكادر الرقمية</div>
            <?php endif; ?>
        </div>
    </div>
    ...
    <div style="margin-top: 25px; padding-top: 12px; border-top: 2px solid #cbd5e1; display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 15px; text-align: center; page-break-inside: avoid;">
        <div style="text-align: right;">
            <div style="font-weight: 800; font-size: 11.5px; color: #0f172a; margin-bottom: 20px;">توقيع المدرب:</div>
