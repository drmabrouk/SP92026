...
$can_manage = current_user_can('manage_grades') || current_user_can('manage_options') || $is_teacher || in_array('sm_principal', $roles) || in_array('sm_coordinator', $roles) || in_array('sm_hod', $roles) || in_array('sm_activities_supervisor', $roles);
...
<div class="sm-grades-management" dir="rtl" style="font-family: 'Cairo', sans-serif !important;">
    ...
    <div style="background: #ffffff; padding: 14px 18px; border-radius: 14px; border: 1px solid #e2e8f0; margin-bottom: 14px; box-shadow: 0 4px 18px rgba(0,0,0,0.02); display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 12px;">
        <div style="display: flex; align-items: center; gap: 12px;">
            ...
            <div>
                <h2 style="margin: 0 0 2px 0; font-size: 18px; font-weight: 800; color: #0f172a;">سجل الدرجات والنتائج الأكاديمية</h2>
                <p style="margin: 0; font-size: 11.5px; color: #64748b; font-weight: 500;">رصد درجات الطلاب الفردية والجماعية، إدارة المواد والمجموعات الدراسية واستخراج التقارير</p>
            </div>
        </div>

        <!-- Primary Header Actions -->
        <div style="display: flex; gap: 8px; align-items: center; flex-wrap: wrap;">
            <button type="button" onclick="document.getElementById('import-grades-modal').style.display='flex'" class="sm-btn" style="background: #1e293b; color: #ffffff !important; height: 34px; border-radius: 9999px !important; padding: 0 16px; font-weight: 800; font-size: 12px; border: none; cursor: pointer; display: inline-flex; align-items: center; gap: 6px;">
